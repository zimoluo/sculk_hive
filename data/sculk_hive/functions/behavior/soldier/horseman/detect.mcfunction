...
execute if data entity @s {HurtTime:9s, DeathTime:0s} on passengers at @s run data modify entity @s Health set from entity @e[type=skeleton_horse,tag=sh_sdr,limit=1,sort=nearest] Health