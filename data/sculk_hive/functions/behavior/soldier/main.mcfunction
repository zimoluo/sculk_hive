...
execute unless entity @e[tag=sh_main, distance=..64, tag=!sh_sdr_disp] run tag @s add sh_sdr_ready
execute unless entity @e[tag=sh_main, distance=..64, tag=!sh_sdr_disp] run function sculk_hive:behavior/soldier/burrow