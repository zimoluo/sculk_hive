...
scoreboard players set @s sh_dynamic_hp_entry 25


scoreboard players remove @s sh_dynamic_hp_player_multiplier 1
scoreboard players set @s sh_dynamic_hp_calc 4
...
execute if score @s sh_dynamic_hp_entry matches 83.. run scoreboard players set @s sh_dynamic_hp_entry 83