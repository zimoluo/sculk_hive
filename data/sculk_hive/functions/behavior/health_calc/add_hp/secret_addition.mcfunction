...
scoreboard players set @s sh_dynamic_hp_entry 20


scoreboard players remove @s sh_dynamic_hp_player_multiplier 1
scoreboard players set @s sh_dynamic_hp_calc 3
...
execute if score @s sh_dynamic_hp_entry matches 65.. run scoreboard players set @s sh_dynamic_hp_entry 65