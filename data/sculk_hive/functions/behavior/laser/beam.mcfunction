...
execute positioned ~-1.75 ~-1 ~-1.75 as @e[tag=sh_atk, dx=2.5, dz=2.5, dy=1] at @s unless entity @s[type=armor_stand] run function sculk_hive:behavior/damage/laser_2
