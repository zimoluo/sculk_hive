...
execute if score @s sh_max_hp matches 300.. run scoreboard players set @s sh_max_hp 300
execute if score @s sh_hp matches 300.. run scoreboard players set @s sh_hp 300
