...
execute if score @s sh_boom_cd matches 90 as @e[tag=sh_main] at @s run function sculk_hive:behavior/final_attack/ultra/effect
execute if score @s sh_boom_cd matches 90 run function sculk_hive:behavior/final_attack/ultra/boom

execute if score @s sh_boom_cd matches 75 as @e[tag=sh_main] at @s run function sculk_hive:behavior/final_attack/ultra/effect
execute if score @s sh_boom_cd matches 75 run function sculk_hive:behavior/final_attack/ultra/boom

execute if score @s sh_boom_cd matches 5..60 if predicate sculk_hive:chance/04 as @e[tag=sh_main] at @s run particle soul_fire_flame ~ ~1.2 ~ 0.3 0.3 0.3 0.0000001 20 force

execute if score @s sh_boom_cd matches 50 as @e[tag=sh_main] at @s run playsound minecraft:entity.warden.sonic_charge hostile @a ~ ~ ~ 2
