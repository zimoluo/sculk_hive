...
execute unless score @s sh_bot_last matches -90 if predicate sculk_hive:chance/06 if score @s sh_bot_xn matches 0 run tp @s ~ ~ ~ 90 0
execute unless score @s sh_bot_last matches 90 if predicate sculk_hive:chance/06 if score @s sh_bot_xp matches 0 run tp @s ~ ~ ~ -90 0
execute unless score @s sh_bot_last matches -180 if predicate sculk_hive:chance/06 if score @s sh_bot_zp matches 0 run tp @s ~ ~ ~ 0 0
execute unless score @s sh_bot_last matches 0 if predicate sculk_hive:chance/06 if score @s sh_bot_zn matches 0 run tp @s ~ ~ ~ 180 0