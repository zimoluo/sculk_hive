...
execute if score @e[tag=sh_main,limit=1, sort=nearest] sh_cat_count matches ..15 if predicate sculk_hive:chance/01 run scoreboard players set @s sh_bot_special_type 1