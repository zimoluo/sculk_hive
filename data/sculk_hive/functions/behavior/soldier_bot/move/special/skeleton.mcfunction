summon skeleton ~ ~-1.5 ~ {Tags:["sh_part","sh_sdr","sh_sdr_raw"], ArmorDropChances:[0f, 0f, 0f, 0f], ArmorItems:[{},{},{},{id:iron_helmet,Count:1b,tag:{Enchantments:[{id:protection,lvl:1s}],Unbreakable:1b}}], NoAI:1b, Invulnerable:1b, ActiveEffects:[{Id:11b, Amplifier:10b, Duration:2147483647, ShowParticles:0b}, {Id:12b, Duration:2147483647, ShowParticles:0b}], Air:32767s, Health:35.0f, Attributes:[{Name:generic.max_health,Base:35.0d},{Name:generic.armor,Base:3.0d},{Name:generic.knockback_resistance, Base:1.0d}],HandItems:[{id:bow,Count:1b}], HandDropChances:[0f, 0f],PersistenceRequired:1b, DeathLootTable:"minecraft:empty"}
