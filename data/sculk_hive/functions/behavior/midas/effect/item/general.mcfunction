...
item replace entity @e[tag=sh_temp_2334,limit=1] weapon.mainhand with gold_ingot
item modify entity @e[tag=sh_temp_2334,limit=1] weapon.mainhand sculk_hive:midas_curse_general
