...
execute if data storage sculk_hive:data {world:{difficulty:2}} positioned ~-2.25 ~-2.25 ~-2.25 as @e[tag=sh_atk,dx=3.5, dy=3.5, dz=3.5] at @s run function sculk_hive:behavior/damage/hit_soul
execute if data storage sculk_hive:data {world:{difficulty:3}} positioned ~-2.5 ~-2.5 ~-2.5 as @e[tag=sh_atk,dx=4, dy=4, dz=4] at @s run function sculk_hive:behavior/damage/hit_soul
execute if data storage sculk_hive:data {world:{difficulty:1}} positioned ~-1.9 ~-1.9 ~-1.9 as @e[tag=sh_atk,dx=2.8, dy=2.8, dz=2.8] at @s run function sculk_hive:behavior/damage/hit_soul
