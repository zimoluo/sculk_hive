...
execute at @e[tag=sh_main,limit=1,sort=nearest, distance=..24] as @a[tag=sh_atk, limit=3, sort=random, distance=5..28, tag=!sh_attracted, predicate=sculk_hive:behavior/near_ground] run scoreboard players add TEMP sh_constant 1
execute at @e[tag=sh_main,limit=1,sort=nearest, distance=..24] as @a[tag=sh_atk, limit=3, sort=random, distance=5..28, tag=!sh_attracted, predicate=sculk_hive:behavior/near_ground] at @s run summon marker ~ ~ ~ {Tags:["sh_walker"]}
execute if score TEMP sh_constant matches 0 at @e[tag=sh_main,limit=1,sort=nearest, distance=..24] as @e[tag=sh_atk, limit=3, sort=random, distance=5..28, type=!player, tag=!sh_attracted, predicate=sculk_hive:behavior/near_ground] at @s run summon marker ~ ~ ~ {Tags:["sh_walker"]}
execute if score TEMP sh_constant matches 1 at @e[tag=sh_main,limit=1,sort=nearest, distance=..24] as @e[tag=sh_atk, limit=2, sort=random, distance=5..28, type=!player, tag=!sh_attracted, predicate=sculk_hive:behavior/round] at @s run summon marker ~ ~ ~ {Tags:["sh_walker"]}
execute if score TEMP sh_constant matches 2 at @e[tag=sh_main,limit=1,sort=nearest, distance=..24] as @e[tag=sh_atk, limit=1, sort=random, distance=5..28, type=!player, tag=!sh_attracted, predicate=sculk_hive:behavior/near_ground] at @s run summon marker ~ ~ ~ {Tags:["sh_walker"]}
