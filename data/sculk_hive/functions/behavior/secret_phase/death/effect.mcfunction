...
playsound minecraft:entity.vex.death hostile @a ~ ~ ~ 4 0.6
execute if predicate sculk_hive:chance/05 run playsound minecraft:entity.generic.explode hostile @a ~ ~ ~ 4
