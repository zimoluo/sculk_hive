...
tag @s add sh_temp_8
execute as @e[tag=sh_corrupted,distance=..256, tag=!sh_scheduled_delete] at @s unless entity @e[tag=sh_main,tag=!sh_temp_8] run function sculk_hive:behavior/vestige/purification/purify
execute as @e[tag=sh_guard_corrupted,distance=..256, tag=!sh_guard_despawn, tag=!sh_scheduled_delete] at @s unless entity @e[tag=sh_main,tag=!sh_temp_8] run function sculk_hive:behavior/vestige/purification/purify
