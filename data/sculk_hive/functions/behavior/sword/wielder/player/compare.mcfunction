...
execute store result score @s sh_swd_UUID_0 run data get entity @s SelectedItem.tag.WielderUUID[0]
execute store result score @s sh_swd_UUID_1 run data get entity @s SelectedItem.tag.WielderUUID[1]
execute store result score @s sh_swd_UUID_2 run data get entity @s SelectedItem.tag.WielderUUID[2]
execute store result score @s sh_swd_UUID_3 run data get entity @s SelectedItem.tag.WielderUUID[3]
