...
execute positioned ~ ~-0.15 ~ run summon minecraft:zoglin ~ ~ ~ {NoAI:1b, Silent:1b, Tags:["sh_part", "sh_cat_hp", "sh_hp_raw", "sh_attackable"], active_effects:[{id:"invisibility", duration:-1, show_particles:0b}, {id:"fire_resistance", duration:-1, show_particles:0b}], Health:60.0f, Air:32767s, NoGravity:1b, Attributes:[{Name:generic.max_health,Base:60.0d},{Name:generic.armor,Base:2.0d},{Name:generic.knockback_resistance, Base:1.0d}],PersistenceRequired:1b, DeathLootTable:"minecraft:empty",CustomNameVisible:0b, CustomName:'{"color":"#006F75","text":"Sculk Hive","italic": false}'}
