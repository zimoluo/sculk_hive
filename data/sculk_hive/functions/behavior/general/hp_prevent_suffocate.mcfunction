...
execute positioned ~ ~-1 ~ if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
execute positioned ~1 ~-1 ~ if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
execute positioned ~-1 ~-1 ~ if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
execute positioned ~ ~-1 ~1 if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
execute positioned ~ ~-1 ~-1 if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
execute positioned ~1 ~-1 ~1 if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
execute positioned ~-1 ~-1 ~1 if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
execute positioned ~-1 ~-1 ~-1 if block ~ ~ ~ moving_piston run setblock ~ ~ ~ air
