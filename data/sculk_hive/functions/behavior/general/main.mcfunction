...
execute unless entity @s[tag=sh_phs] if entity @s[tag=!sh_2nd] run function sculk_hive:behavior/general/bossbar
execute unless entity @s[tag=sh_phs] if entity @s[tag=sh_2nd] unless entity @s[tag=sh_final] run function sculk_hive:behavior/general/bossbar_2nd
execute unless entity @s[tag=sh_dth] unless entity @s[tag=sh_phs] if entity @s[tag=sh_final] run function sculk_hive:behavior/general/bossbar_final
execute if entity @s[tag=sh_phs] run function sculk_hive:behavior/general/bossbar_phase
...
execute unless entity @s[tag=sh_phs] unless entity @e[tag=sh_cat] unless entity @s[tag=sh_2nd] if entity @e[tag=sh_kck] run function sculk_hive:behavior/general/2nd_phase/init
execute unless entity @s[tag=sh_phs] if entity @s[tag=sh_2nd] unless entity @e[tag=sh_sey] unless entity @s[tag=sh_final] run function sculk_hive:behavior/general/final/init
execute unless entity @s[tag=sh_phs] unless entity @e[tag=sh_cat] unless entity @s[tag=sh_2nd] unless entity @e[tag=sh_kck] run function sculk_hive:behavior/general/final/init
...
execute unless entity @s[tag=sh_dth] unless entity @a[distance=..128] run function sculk_hive:behavior/despawn/disappear
