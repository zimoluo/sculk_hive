execute unless block ~ ~ ~ sculk_shrieker run function sculk_hive:behavior/general/blocks/trigger_dth
execute unless block ~ ~-1 ~ sculk run function sculk_hive:behavior/general/blocks/trigger_dth
execute unless block ~ ~-2 ~ sculk run function sculk_hive:behavior/general/blocks/trigger_dth
execute unless block ~1 ~-2 ~ sculk run function sculk_hive:behavior/general/blocks/trigger_dth
execute unless block ~-1 ~-2 ~ sculk run function sculk_hive:behavior/general/blocks/trigger_dth
execute unless block ~ ~-2 ~1 sculk run function sculk_hive:behavior/general/blocks/trigger_dth
execute unless block ~ ~-2 ~-1 sculk run function sculk_hive:behavior/general/blocks/trigger_dth
