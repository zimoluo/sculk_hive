...
execute as @e[tag=sh_cat_hp] store result score @s sh_hp run data get entity @s Health
execute as @e[tag=sh_cat_hp] store result score @s sh_max_hp run data get entity @s Attributes[{Name:"minecraft:generic.max_health"}].Base

execute as @e[tag=sh_cat_hp] run scoreboard players operation @e[tag=sh_main] sh_hp += @s sh_hp
execute as @e[tag=sh_cat_hp] run scoreboard players operation @e[tag=sh_main] sh_max_hp += @s sh_max_hp
