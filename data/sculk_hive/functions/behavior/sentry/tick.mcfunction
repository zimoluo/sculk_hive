...
execute if score @s sh_boom_cd matches 30 positioned ~ ~1.2 ~ if entity @e[tag=sh_atk, distance=..10] run playsound minecraft:entity.warden.sonic_charge hostile @a ~ ~ ~ 2 1.8
