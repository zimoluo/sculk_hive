execute positioned ~2.5 ~1 ~0.5 if block ~ ~ ~ fire run setblock ~ ~ ~ air
execute positioned ~2.5 ~1 ~1.5 if block ~ ~ ~ fire run setblock ~ ~ ~ air
execute positioned ~2.5 ~1 ~2.5 if block ~ ~ ~ fire run setblock ~ ~ ~ air
execute positioned ~2.5 ~1 ~-0.5 if block ~ ~ ~ fire run setblock ~ ~ ~ air
execute positioned ~2.5 ~1 ~-1.5 if block ~ ~ ~ fire run setblock ~ ~ ~ air
execute positioned ~-2.5 ~1 ~0.5 if block ~ ~ ~ fire run setblock ~ ~ ~ air
execute positioned ~-2.5 ~1 ~1.5 if block ~ ~ ~ fire run setblock ~ ~ ~ air
