...
execute positioned ~ ~-0.15 ~ run summon minecraft:zoglin ~ ~ ~ {NoAI:1b, Silent:1b, Tags:["sh_part", "sh_cat_hp", "sh_cat_top_hp", "sh_hp_raw", "sh_attackable"], ActiveEffects:[{Id:14b, Duration:2147483647, ShowParticles:0b}, {Id:12, Duration:2147483647, ShowParticles:0b}], Health:150.0f, Air:32767s, NoGravity:1b, Attributes:[{Name:generic.max_health,Base:150.0d},{Name:generic.armor,Base:3.5d},{Name:generic.knockback_resistance, Base:1.0d}], PersistenceRequired:1b, DeathLootTable:"minecraft:empty",CustomNameVisible:0b, CustomName:'{"color":"#006F75","text":"Sculk Hive","italic": false}'}
